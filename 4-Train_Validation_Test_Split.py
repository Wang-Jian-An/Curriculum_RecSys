...
inputJsonFilePath = os.path.join(main_path, "raw_data", "Correlations_with_oneHotEncoding_and_SinglePairs_for_development.json.gz")
outputJsonFilePath = os.path.join(main_path, "raw_data", "SplitData_for_Correlation_for_development.json.gz")

if __name__ == "__main__":

    rawCorrelation = compress_json.load(inputJsonFilePath)
    ...
    compress_json.dump(pd.DataFrame(totalResult).to_dict("records"), outputJsonFilePath)